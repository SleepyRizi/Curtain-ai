...
// // ----------------------------------------------------------------
// function App() {
//   // React 18 concurrency helper for texture transitions
//   const [, startTransitionFn] = React.useTransition();

//   // ----------------------------------------------------------------
//   // Fixed Curtain Model (Curtain 5)
//   // ----------------------------------------------------------------
...
//   useEffect(() => {
//     if (texture) {
//       // Set the texture to use sRGBEncoding to maintain its true color
...
//   // ----------------------------------------------------------------
//   // Left Panel (Fixed Model info & Texture selection)
//   // ----------------------------------------------------------------
...
//       {/* LEFT PANEL (Fixed Model & Texture Selection) */}
//       <div style={panelStyle}>
//         {/* Fixed Model Section */}
//         <div>
//           <div style={sectionTitle}>Model</div>
//           <div style={{ fontSize: 14 }}>Curtain 5</div>
//         </div>
